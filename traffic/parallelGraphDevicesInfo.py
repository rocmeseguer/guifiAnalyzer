...
def parallelGraphDevicesInfo(root,core):
...
if __name__ == "__main__":
    #graphDevicesInfo (1,2,3) #rootZone (True|False)
    # provide rootZone and if you want core data or not
    # and choose 1: download graph info of devices and store to db
    #                     2: show from db graph info of devices
    if len(sys.argv) == 3:
        if sys.argv[1] == '1':
